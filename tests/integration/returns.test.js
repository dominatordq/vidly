...
describe('/api/returns', () => {
    ...
    it('should calculate rentalFee if input is valid', async () => {
        rental.dateOut = moment().add(-7, 'days').toDate();    // set Date/time to 7 days ago 
        await rental.save();
        ...
        expect(rentalInDb.rentalFee).toBe(14);  // $2 a day for 7 days (7 * 2 = $14) 
    });
    ...
    it('should return the rental if input is valid', async () => {
        ...
        expect(Object.keys(res.body)).toEqual(
            expect.arrayContaining(['dateOut', 'dateReturned', 'movie', 'rentalFee', 'customer'])    
        );
    });
});